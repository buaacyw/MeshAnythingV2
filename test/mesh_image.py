...
from ..cma_utils import Dataset, conv_pil_tensor, conv_tensor_pil


def mesh_image(image_path: str):
    ...
    set_seed(0)
    dataset = Dataset("pc_normal", [image_path], False, 7)
...
input_image1_path = os.path.join(os.path.dirname(__file__), "image1.png")
mesh_image(input_image1_path)