...
def load_model(ckpt_path="meshanything_train/miche/checkpoints/aligned_shape_latents/shapevae-256.ckpt"):
    model_config = OmegaConf.load("meshanything_train/miche/configs/aligned_shape_latents/shapevae-256.yaml")
